...
import { OWLIA_GUARD_ABI } from '../src/user/abis/owliaGuard.abi';
import { UNISWAP_V3_OWLIA_VALIDATOR_ABI } from '../src/user/abis/uniswapV3OwliaValidator.abi';
import { AAVE_V3_OWLIA_VALIDATOR_ABI } from '../src/user/abis/aaveV3OwliaValidator.abi';
import { EULER_V2_OWLIA_VALIDATOR_ABI } from '../src/user/abis/eulerV2OwliaValidator.abi';
