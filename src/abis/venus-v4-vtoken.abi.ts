export const VENUS_V4_VTOKEN_ABI = [
  { inputs: [], stateMutability: 'nonpayable', type: 'constructor' },
  { inputs: [], name: 'FlashLoanAlreadyActive', type: 'error' },
  {
    inputs: [
  ...
  { inputs: [], name: 'InsufficientCash', type: 'error' },
  {
    inputs: [
      { internalType: 'uint256', name: 'actualAmount', type: 'uint256' },
      { internalType: 'uint256', name: 'requiredTotalFee', type: 'uint256' },
    ],
  ...
  {
    inputs: [
      { internalType: 'uint256', name: 'reduceAmount_', type: 'uint256' },
    ],
