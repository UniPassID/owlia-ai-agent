export const EULER_V2_UTILS_LENS_ABI = [
  {
    inputs: [
      {
      ...
      { internalType: 'address', name: '_oracleLens', type: 'address' },
    ],
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: 'bool', name: 'isEVault', type: 'bool' },
        ],
  ...
  },
  {
    ...
    name: 'oracleLens',
    outputs: [
      { internalType: 'contract OracleLens', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
