...
export class AaveV3SupplyResponseDto {
  @ApiProperty({
...
export class AaveV3BorrowResponseDto {
  @ApiProperty({
...
export class AaveV3RewardsResponseDto {
  @ApiProperty({
...
export class AaveV3ProtocolBlockResponseDto {
  @ApiProperty({
